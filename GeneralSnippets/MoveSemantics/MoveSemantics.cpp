...
namespace MoveSemantics {
    ...
    {
        std::string aString("12345");

        // ...

        std::vector<std::string> zeichenketten;

        zeichenketten.push_back(std::move(aString));
      //  zeichenketten.push_back(aString);

        std::cout << "whoAmI: " << aString << std::endl;
    }
